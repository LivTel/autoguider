...
int Autoguider_CIL_Server_Initialise(void)
{
	...
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_Server_Initialise",LOG_VERBOSITY_TERSE,
				      "CIL","started.");
#endif
...
#if AUTOGUIDER_DEBUG > 1
	 Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Server_Initialise",LOG_VERBOSITY_TERSE,
				"CIL","NGATCil_AGS_SDB_Initialise.");
#endif
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Server_Start",LOG_VERBOSITY_TERSE,
			       "CIL","started.");
#endif
	if(CIL_UDP_Server_Start)
	{
#if AUTOGUIDER_DEBUG > 2
		Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_Server_Start",
					      LOG_VERBOSITY_VERBOSE,"CIL","Starting server on port %d.",CIL_UDP_Port);
#endif
...
int Autoguider_CIL_Server_Stop(void)
{
	int retval;
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Server_Stop",LOG_VERBOSITY_TERSE,
			       "CIL","started.");
#endif
	if(CIL_UDP_Server_Start)
	{
...
#if AUTOGUIDER_DEBUG > 2
		Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Server_Stop",LOG_VERBOSITY_TERSE,
				       "CIL","NOT started so not stopping CIL server.");
#endif
	}
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Server_Stop",LOG_VERBOSITY_TERSE,
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Open",LOG_VERBOSITY_INTERMEDIATE,
			       "CIL","started.");
#endif
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Open",
				      LOG_VERBOSITY_VERBOSE,"CIL","Opening %s:%d.",
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Send",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL",
...
#if AUTOGUIDER_DEBUG > 1
		Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Send",
					      LOG_VERBOSITY_VERY_VERBOSE,"CIL","Send is FALSE:Did not send packet:"
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Send",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","finished.");
#endif
	return TRUE;
}
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Close",
			       LOG_VERBOSITY_INTERMEDIATE,"CIL","started.");
#endif
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_Guide_Packet_Close",
			       LOG_VERBOSITY_INTERMEDIATE,"CIL","finished.");
#endif
	return TRUE;
}
...
{
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_State_Set",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL","State Set(%d):started.",state);
#endif
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_State_Set",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","finished.");
#endif
	return TRUE;
}
...
{
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Exp_Time_Set",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL","Exposure Time Set(%d ms):started.",ms);
#endif
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Exp_Time_Set",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","finished.");
#endif
	return TRUE;
}
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Centroid_Set",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL",
				      "Centroid Set(cx=%.2f,cy=%.2f,fwhm=%.2f,mag%.2f):started.",cx,cy,fwhm,mag);
#endif
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Centroid_Set",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","Autoguider_CIL_SDB_Packet_Centroid_Set:finished.");
#endif
	return TRUE;
}
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Window_Set",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL",
				      "Window Set(tlx=%d,tly=%d,brx=%d,bry=%d):started.",tlx,tly,brx,bry);
#endif
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Window_Set",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","Autoguider_CIL_SDB_Packet_Window_Set:finished.");
#endif
	return TRUE;
}
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log("cil","autoguider_cil.c","Autoguider_CIL_SDB_Packet_Send",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","started.");
#endif
	if(CIL_SDB_Send)
	{
...
#if AUTOGUIDER_DEBUG > 1
	Autoguider_General_Log_Format("cil","autoguider_cil.c","Autoguider_CIL_Server_Connection_Callback",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL","started.");
#endif
#endif
				   ...
				   size_t message_length)
{
	...
	{
		Autoguider_General_Log_Format("cil","autoguider_cil.c","CIL_Command_CHB_Process",
					      LOG_VERBOSITY_VERY_VERBOSE,"CIL","Received/Processed %d heartbeats.",
					      CIL_CHB_Count);
	}
#endif
	return TRUE;
				   ...
				   size_t message_length)
{
	...
	switch(cil_packet.Service)
	{
		...
		case E_MCP_ACTIVATE:
			...
			Autoguider_General_Log_Format("cil","autoguider_cil.c",
			        "CIL_Command_MCP_Process",LOG_VERBOSITY_VERY_VERBOSE,"CIL",
				"Processing MCP Activate request.");
#endif
		...
		case E_MCP_SAFESTATE:
			...
			Autoguider_General_Log_Format("cil","autoguider_cil.c",
			        "CIL_Command_MCP_Process",LOG_VERBOSITY_VERY_VERBOSE,"CIL",
				"Processing MCP Safe state request.");
#endif
				   ...
				   size_t message_length)
{
	...
	switch(ags_cil_packet.Command)
	{
		case E_AGS_GUIDE_ON_BRIGHTEST:
			...
			Autoguider_General_Log_Format("cil","autoguider_cil.c",
						      "CIL_Command_TCS_Process",LOG_VERBOSITY_INTERMEDIATE,"CIL",
						      "Command is autoguider on brightest.");
#endif
		...
		case E_AGS_GUIDE_ON_PIXEL:
			...
			Autoguider_General_Log_Format("cil","autoguider_cil.c",
						      "CIL_Command_TCS_Process",LOG_VERBOSITY_INTERMEDIATE,"CIL",
						      "Command is autoguider on pixel.");
#endif
		...
		case E_AGS_START_SESSION:
			...
			Autoguider_General_Log_Format("cil","autoguider_cil.c",
						      "CIL_Command_TCS_Process",LOG_VERBOSITY_INTERMEDIATE,"CIL",
						      "Command is start session.");
#endif
			/* write INIT to SDB. */
			if(!Autoguider_CIL_SDB_Packet_State_Set(E_AGG_STATE_INIT))
			{
				Autoguider_General_Error("cil","autoguider_cil.c","CIL_Command_TCS_Process",
							 LOG_VERBOSITY_INTERMEDIATE,"CIL"); /* no need to fail */
			}
...
#if AUTOGUIDER_DEBUG > 3
	Autoguider_General_Log("cil","autoguider_cil.c","CIL_UDP_Autoguider_On_Brightest_Reply_Send",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","started.");
#endif
...
#if AUTOGUIDER_DEBUG > 3
	Autoguider_General_Log("cil","autoguider_cil.c","CIL_UDP_Autoguider_On_Pixel_Reply_Send",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","started.");
#endif
...
#if AUTOGUIDER_DEBUG > 3
	Autoguider_General_Log("cil","autoguider_cil.c","CIL_UDP_Autoguider_On_Rank_Reply_Send",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","started.");
#endif
#if AUTOGUIDER_DEBUG > 3
	Autoguider_General_Log_Format("cil","autoguider_cil.c","CIL_UDP_Autoguider_On_Rank_Reply_Send",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL",
				      "Opening UDP connection to %s:%d.",TCC_Hostname,CIL_TCS_UDP_Port);
#endif
...
#if AUTOGUIDER_DEBUG > 3
	Autoguider_General_Log("cil","autoguider_cil.c","CIL_UDP_Autoguider_Off_Reply_Send",
			       LOG_VERBOSITY_VERY_VERBOSE,"CIL","started.");
#endif
#if AUTOGUIDER_DEBUG > 3
	Autoguider_General_Log_Format("cil","autoguider_cil.c","CIL_UDP_Autoguider_Off_Reply_Send",
				      LOG_VERBOSITY_VERY_VERBOSE,"CIL","Opening UDP connection to %s:%d.",
