...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Load(%s).",filename);
#endif
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Load(%s) returned %d.",filename,retval);
#endif
	return retval;
}
...
#ifdef CCD_DEBUG
	CCD_General_Log(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Shutdown starteded: "
			"About to call eSTAR_Config_Destroy_Properties.");
#endif
	eSTAR_Config_Destroy_Properties(&Config_Properties);
#ifdef CCD_DEBUG
	CCD_General_Log(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Shutdown finished.");
#endif
	return retval;
}
...
int CCD_Config_Get_String(char *key, char **value)
{
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_String(%s,%p).",key,value);
#endif
	...
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_String(%s) returned %s (%d).",
			       key,(*value),retval);
#endif
	return retval;
}
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Integer(%s,%p).",key,i);
#endif
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Integer(%s) returned %d.",
			       key,*i);
#endif
	return retval;
}
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Long(%s,%p).",key,l);
#endif
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Long(%s) returned %ld.",
			       key,*l);
#endif
	return retval;
}
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Unsigned_Short(%s,%p).",key,us);
#endif
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Unsigned_Short(%s) returned %hu.",
			       key,*us);
#endif
	return retval;
}
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Double(%s,%p).",key,d);
#endif
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Double(%s) returned %.2f.",key,*d);
#endif
	return retval;
}
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Boolean(%s,%p).",key,boolean);
#endif
...
#ifdef CCD_DEBUG
	CCD_General_Log_Format(CCD_GENERAL_LOG_BIT_CONFIG,"CCD_Config_Get_Boolean(%s) returned %d.",key,*boolean);
#endif
	return retval;
}
